...
export default {
  ...
  methods: {
    async deletePeople() {
      await axios.delete(`https://1472-185-233-200-96.eu.ngrok.io?employee_id=${this.emp_id}`)
    },
    closePopup() {
      this.$emit('onClose')
    },
    async getPeople() {
      const employee = await axios.get(`https://1472-185-233-200-96.eu.ngrok.io/get_employee?employee_id=${this.emp_id}`)
